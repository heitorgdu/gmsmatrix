					...
					<div class="signup-header">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group md-form">
                                    ...
                                    <label class="wrap_form_control <?php if(old('email')!='') echo('active'); ?>" for="email"> Email Address*</label>
                                    @if ($errors->has('email'))
                                ...
                                <div class="col-sm-6 form-group md-form">
                                    <input id="username" class="form-control margin-bottom-20" type="text" value="{{ old('username') }}" name="username" id="username" required />
									<label class="wrap_form_control <?php if(old('username')!='') echo('active'); ?>" for="username">User Name*
                                        
                                    </label>
                                    @if ($errors->has('username'))
                                        <span class="help-block" style="font-size: 12px !important;">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                   <div class="g-recaptcha" data-type="image" data-sitekey="6LdxDSkUAAAAACEOKnsMTF1CuqEUFtOuCKr-JUB4"></div>
								 <span class="help-block" style="color:red;display:none;" id="cp_bx">
